...
class PaycecReadFile:
    ...
    def read_file_html(self, filename):
        ...
        return content
    # def get_faqs_title_and_slug(self, selector, num_of_faqs):
    #     cell_title_array = []
    ...
    #     cell_array = self.driver.find_elements(
    #         By.CSS_SELECTOR, ".bootstrap-datatable > tbody > tr > td:nth-child(2)")
    #     title_arr, sug_title_arr = self.get_faqs_title_and_slug(
    ...
    #     edit_btn = self.driver.find_elements(By.CSS_SELECTOR, ".btn.btn-info")
